// src/pages/suratPengantar/SuratPengantarDetail.jsx
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 font-mono">
                                        {detail.nik?.replace(/(\d{4})(\d{4})(\d{4})(\d{4})/, '$1-$2-$3-$4')}
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900">
                                        {detail.pob}, {new Date(detail.dob).toLocaleDateString('id-ID', {
                                            day: 'numeric',
                                            month: 'long',
                                            year: 'numeric'
                                        })}
                        ...
                        {/* Approval Notes */}
                        {(detail.rt_notes || detail.rw_notes) && (
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-6">
                                    💬 Catatan Persetujuan
                                </h3>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-gray-900">{getStatusBadge(detail.status)}</span>
                                </div>
                            </div>
