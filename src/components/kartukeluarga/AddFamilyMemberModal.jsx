// src/components/kartuKeluarga/AddFamilyMemberModal.jsx
...
const AddFamilyMemberModal = ({ onClose, kkData }) => {
    const { addFamilyMember, isAddingMember } = useKartuKeluarga();
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h2 className="text-xl font-semibold text-gray-900">Tambah Anggota Keluarga</h2>
                            <p className="text-sm text-gray-600">Lengkapi data anggota keluarga baru</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6">
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 mb-6">
                        <h3 className="font-medium text-blue-900 mb-2">Informasi Kartu Keluarga</h3>
