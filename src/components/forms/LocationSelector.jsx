// src/components/forms/LocationSelector.jsx - Enhanced error handling
...
const LocationSelector = ({ onLocationChange, error }) => {
    ...
    // Queries for location data with better error handling
    ...
    return (
        ...
        {/* Show error if provinces failed to load */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
                <option value="">
                {provincesQuery.isLoading ? 'Memuat...' : 
                provincesQuery.isError ? 'Error memuat data' : 
                'Pilih Provinsi'}
                </option>
                {safeGetData(provincesQuery.data).map((province) => (
            ...
            >
                <option value="">
                {citiesQuery.isLoading ? 'Memuat...' : 
                citiesQuery.isError ? 'Error memuat data' :
                'Pilih Kota/Kabupaten'}
                </option>
                {safeGetData(citiesQuery.data).map((city) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
                <option value="">
                {kecamatanQuery.isLoading ? 'Memuat...' : 
                kecamatanQuery.isError ? 'Error memuat data' :
                'Pilih Kecamatan'}
                </option>
                {safeGetData(kecamatanQuery.data).map((kecamatan) => (
            ...
            >
                <option value="">
                {kelurahanQuery.isLoading ? 'Memuat...' : 
                kelurahanQuery.isError ? 'Error memuat data' :
                'Pilih Kelurahan/Desa'}
                </option>
                {safeGetData(kelurahanQuery.data).map((kelurahan) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
                <option value="">
                {rwQuery.isLoading ? 'Memuat...' : 
                rwQuery.isError ? 'Error memuat data' :
                'Pilih RW'}
                </option>
                {safeGetData(rwQuery.data).map((rw) => (
            ...
            >
                <option value="">
                {rtQuery.isLoading ? 'Memuat...' : 
                rtQuery.isError ? 'Error memuat data' :
                'Pilih RT'}
                </option>
                {safeGetData(rtQuery.data).map((rt) => (
        ...
        {/* Loading States */}
        {(provincesQuery.isLoading || citiesQuery.isLoading || kecamatanQuery.isLoading || 
            kelurahanQuery.isLoading || rwQuery.isLoading || rtQuery.isLoading) && (
